...
task SummarizeMetrics {
    ...
    command <<<
        ...
        stats_dict = {
            ...
            'target_af_all': target_af_all,
            'panel_hwe': panel_hwe, 
            'target_hwe': target_hwe,
            'panel_mean_alt_alleles_all': panel_mean_alt_alleles_all, 
            'target_mean_alt_alleles_all': target_mean_alt_alleles_all,
            'sample_stats': {
                'panel': {
            ...
            'panel_samples': list(panel_samples), 
            'target_samples': list(target_samples)
        }
        
        with open(f"{output_prefix}.summary.pkl", "wb") as f:
...
task PlotSummaries {
    ...
    command <<<
        ...
        agg = {
            ...
            'panel_af_all': [], 
            'target_af_all': [], 
            'panel_mean_alt_alleles_all': [], 
            'target_mean_alt_alleles_all': []
        }
