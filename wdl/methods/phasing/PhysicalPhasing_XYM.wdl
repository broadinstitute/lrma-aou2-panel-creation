...
task HiPhase {
    ...
    command <<<
        ...
        samtools view -b --use-index --customized-index -@ $(nproc) ~{bam} ~{bam_idx} chrX chrY chrM > ~{sample_name}.XYM.bam
        samtools index ~{sample_name}.XYM.bam
