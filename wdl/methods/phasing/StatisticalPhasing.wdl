...
workflow StatisticalPhasing {
    ...
    input {
        ...
        String chunk_extra_args = "--thread $(nproc) --window-size 1000000 --buffer-size 200000 --window-count 100000 --buffer-count 5000" # we want window counts to drive the constraints
...
task CreateShapeitChunks {
    input {
        ...
        File vcf_idx
        String region
        String extra_args = "--thread $(nproc) --window-size 1000000 --buffer-size 200000 --window-count 100000 --buffer-count 5000" # we want window counts to drive the constraints
