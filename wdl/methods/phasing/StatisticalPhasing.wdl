...
workflow StatisticalPhasing {
    ...
    input {
        ...
        String chunk_extra_args = "--thread $(nproc) --sequential --uniform-number-variants --window-count 50000 --buffer-count 1000 --window-mb 2 --buffer-mb 0.2 --sparse-maf 0"
...
task CreateShapeitChunks {
    input {
        ...
        String region
        File genetic_map
        String extra_args = "--thread $(nproc) --sequential --uniform-number-variants --window-count 50000 --buffer-count 1000 --window-mb 2 --buffer-mb 0.2 --sparse-maf 0"
