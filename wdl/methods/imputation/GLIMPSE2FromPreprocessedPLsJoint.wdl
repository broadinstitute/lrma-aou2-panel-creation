...
task GLIMPSE2Ligate {
    ...
    command <<<
        ...
        # memory would otherwise track cpu_cores. Raised 2 -> 4 now that there is a
        # measurement: the peak was 12.39 GiB at 2 threads against a 24 GiB request, so even
        # if each additional thread costs ~1 GiB of decompression buffer there is roughly 9
