...
EXPECTED_VCF_GZ=$REPO_DIR/test/resources/large/statistical-phasing/expected/40-HPRC-1kGP.hiphase.sv.merged.chr6-70M-80M.phase.common.rare.concat.vcf.gz
