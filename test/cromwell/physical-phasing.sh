...
sed -e "s|__REPO_DIR__|$REPO_DIR|g" $REPO_DIR/test/resources/physical-phasing/physical-phasing.json > $REPO_DIR/test/resources/physical-phasing/physical-phasing.mod.json

java -jar $CROMWELL_JAR run $REPO_DIR/wdl/methods/phasing/PhysicalPhasing.wdl -i $REPO_DIR/test/resources/physical-phasing/physical-phasing.mod.json -m $REPO_DIR/test/resources/physical-phasing/physical-phasing.mod.output.json
