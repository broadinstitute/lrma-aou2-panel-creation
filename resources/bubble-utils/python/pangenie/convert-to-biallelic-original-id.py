...
# identical to https://github.com/eblerjana/pangenie/blob/master/pipelines/run-from-callset/scripts/convert-to-biallelic.py except with / -> | in GTs and
# with original IDs in ID field
